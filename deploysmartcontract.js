const { Client, PrivateKey, FileCreateTransaction, ContractCreateTransaction, ContractFunctionParameters, ContractCallQuery, ContractExecuteTransaction, Hbar } = require("@hashgraph/sdk");
...
async function environmentSetup() {
    ...
    let helloHedera = require("./Helloworld.json");
    ...
    const contractTx = await new ContractCreateTransaction()
        ...
        .setGas(300000) // Or a higher value if needed
